...
File 7-is_palindrome.c returns 1 if a string is a palindrome and 0 if not.

File 100-wildcmp.c compares two strings and returns 1 if the strings can be considered identical, otherwise return 0. It uses the concept of wildcards.

File _putchar.c contains the _putchar function.

File main.h contains the function prototypes
